...
export interface Plats {
   ...
   */
  @Component({
    selector: 'app-plat-controle',
    styleUrls: ['./plat-controle.component.scss'],
    templateUrl: './plat-controle.component.html',
  })
  export class PlatControleComponent implements OnInit {
